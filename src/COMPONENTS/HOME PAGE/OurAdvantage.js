...
const OurAdvantage = () => {
  return (
    <div className='py-[5rem] w-[70%] mx-auto'>
      <h1 className='text-[2.7rem] pb-[2.5rem] font-bold text-center text-deepGray'>Our Advantage</h1>
      <div className='grid grid-cols-4'>
        <div>
          <p className='text-[6rem] text-white flex justify-center mb-[1rem]'><MdWifiTethering className='bg-primary py-[1rem] rounded-[50%] outline outline-[lightgray] outline-[2px] outline-offset-[.3rem]'/></p>
        ...
        <div>
          <p className='text-[6rem] text-white flex justify-center mb-[1rem]'><FaBus className='bg-primary py-[1rem] rounded-[50%] outline outline-[lightgray] outline-[2px] outline-offset-[.3rem]'/></p>
        ...
        <div>
          <p className='text-[6rem] text-white flex justify-center mb-[1rem]'><MdAirlineSeatReclineExtra className='bg-primary py-[1rem] rounded-[50%] outline outline-[lightgray] outline-[2px] outline-offset-[.3rem]'/></p>
        ...
        <div>
          <p className='text-[6rem] text-white flex justify-center mb-[1rem]'><RiSecurePaymentFill className='bg-primary py-[1rem] rounded-[50%] outline outline-[lightgray] outline-[2px] outline-offset-[.3rem]'/></p>
